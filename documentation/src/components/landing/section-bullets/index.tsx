...
export const SectionBullets = () => {
    ...
    return (
        ...
        <motion.div ref={ref} className="h-auto lg:h-[100vh] bg-white">
            ...
            <motion.div
                ref={innerRef}
                className="relative top-0 left-0 flex flex-col w-screen h-auto pt-8 -mt-px overflow-x-hidden overflow-y-hidden lg:pt-8 max-w-ful lg:h-screen lg:snap-start"
            >
                <motion.div
                ...
                >
                    ...
                    <div className="text-center font-montserrat font-medium text-lg lg:text-2xl text-[#2A2A42] tracking-wide">
                        <p className="mb-0">
